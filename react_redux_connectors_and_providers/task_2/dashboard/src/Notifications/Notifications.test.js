...
describe('<Notifications />', () => {
    ...
    it('calls markNotificationAsRead with the right id', () => {
        // first set some content for pass into NotificationItems
        const listNotifications = [
            { id: 1, type: 'default', value: 'New course available' },
            { id: 2, type: 'urgent', value: 'New resume available' },
        ...
        // now let's mock up our function
        ...
        // let's delete the third one using enzyme's 'at' method to grab an item at a specific index
        wrapper.find('NotificationItem').at(2).props().markAsRead();
        // and hope it's gone!
        expect(mockMarkNotificationAsRead).toHaveBeenCalledWith(3);
    });
